"""
═══════════════════════════════════════════════════════════
 MabiliSSS Queue — Database Layer V2.3.0-P3 (Supabase)
...
def get_short_label(cat, max_len=20):
    """Return short_label if set, else auto-truncate label to max_len chars."""
    sl = (cat.get("short_label") or "").strip()
    if sl:
        return sl
    label = cat.get("label", "")
